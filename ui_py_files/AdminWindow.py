...
class Ui_Admin(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(30, 20, 351, 411))
        ...
        self.radioButton_head_teacher = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_head_teacher.setFont(font)
        self.radioButton_head_teacher.setObjectName("radioButton_head_teacher")
        self.verticalLayout_7.addWidget(self.radioButton_head_teacher)
        self.radioButton_teacher = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_teacher.setFont(font)
        self.radioButton_teacher.setObjectName("radioButton_teacher")
        self.verticalLayout_7.addWidget(self.radioButton_teacher)
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton_head_teacher.setText(_translate("Form", "Завуч"))
        self.radioButton_teacher.setText(_translate("Form", "Преподаватель"))
